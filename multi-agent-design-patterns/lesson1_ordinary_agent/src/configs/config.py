...
class Config(BaseModel):
    ...
    default_model: str = Field(default="qwen3.5-plus-2026-02-15", description="默认模型")
    fallback_model: str = Field(default="qwen3.5-122b-a10b3", description="备用模型")
    flash_model: str = Field(default="qwen3.5-flash-2026-02-23", description="快速模型")
